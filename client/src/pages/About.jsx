        ...
        <div className="bg-white dark:bg-gray-900">
          <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
              <figure className="max-w-screen-md mx-auto">
                  ...
                  <blockquote>
                      <p className="text-2xl font-medium text-gray-900 dark:text-white">"Fun facts about me: I love traveling, I'm a huge fan of fiction novels, I drink hot water like it’s coffee, I volunteer with Be My Eyes, and I’m dreaming of owning a cat someday!"</p>
                  </blockquote>
